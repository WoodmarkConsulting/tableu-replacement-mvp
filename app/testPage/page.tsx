        ...
        components: [
          {
            ...
            mockData: [
              ...
              { kind: "region", regionCode: "FR", value: 58, label: "France" },
              { kind: "region", regionCode: "JP", value: 76, label: "Japan" },
              { kind: "region", regionCode: "BR", value: 45, label: "Brazil" },
              { kind: "point", lat: 40.7128, lng: -74.006, value: 14, label: "New York" },
              { kind: "point", lat: 51.5074, lng: -0.1278, value: 19, label: "London" },
              { kind: "point", lat: 35.6762, lng: 139.6503, value: 16, label: "Tokyo" },
            ],
            chartConfig: {
              projection: {
                type: "geoMercator",
