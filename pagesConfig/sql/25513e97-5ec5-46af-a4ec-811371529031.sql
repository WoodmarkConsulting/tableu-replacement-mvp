...
-- Chart: Engine Series (BarChartModule)
-- Data: Count of error records (row count) grouped by engine series (top 15)
...
WHERE Motorbaureihe IS NOT NULL
