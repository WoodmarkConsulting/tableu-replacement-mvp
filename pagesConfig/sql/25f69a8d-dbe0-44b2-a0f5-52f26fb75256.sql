-- Global KPI: 
-- Anzahl Fehler: number of non-null diagnostic error records.
...
SELECT 'Anzahl Fehler' AS label, CAST(COUNT(ecu_fault_nm) AS DOUBLE) AS value
FROM westeurope_extollo_2026007fielddatadev75cd75.`2018001_xd_td_sofa_dev`.v_xd_diag_ecu_fault
CROSS JOIN chart_input
-- Keep only records with an error and apply every optional dashboard filter.
